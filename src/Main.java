...
public class Main {
    public static void main(String[] args){
        ...
        DatabaseNode secondNode = new DatabaseNode(2802, "secondNode", "2");
        DatabaseNode mainNode = new DatabaseNode(2801, "mainNode", "1", new InetSocketAddress(secondNode.getTcpPort()));
